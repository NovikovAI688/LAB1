...
{
    /// <summary>
    /// Класс для пассивного элемента
    /// </summary>
    public class RandomPassiveElement
    {
        /// <summary>
        /// Рандомные числа для элемента.
        /// </summary>
        /// <param name="minimum">Миниммум.</param>
        ...
        /// Рандомный параметр.
        /// </summary>
        /// <param name="passiveElementType">Вид элемента.</param>
            ...
            switch (passiveElementType)
            {
                ...
                default:
                    throw new ArgumentException
                        ("Введите заданные пассивные элементы");
            }
        }
    }
}
